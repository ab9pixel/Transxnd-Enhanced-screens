...
const Button = ({ icon, text, dropdown, lessPadding, onClick }) => {
  ...
  return (
    <div className="RateButton" style={{ position: "relative" }}>
      <button
        onClick={onClick}
        style={{ paddingLeft: lessPadding ? "5px" : "33px" }}
      >
        <img
          className="white-calculator"
          src={icon}
          alt="Awesome_Calculate_Error"
        />
        {/* <svg>
          <use href={calc} />
        </svg> */}
        ...
        {dropdown && (
          <svg
            ...
            width="13.352"
            height="8.309"
            viewBox="0 0 13.352 8.309"
          >
            <path
              id="Path_7650"
              data-name="Path 7650"
              d="M-22375.963,20575.891l6.676,8.309,6.676-8.309Z"
              transform="translate(22375.963 -20575.891)"
              fill="#fff"
            />
          </svg>
        )}
